...
public class EmailConfig
{
	...
	private static String getEmailBody(ImmutableList<CM2OfferData> offersData, String zip)
	{
		...
		sb.append(String.format(email_body_part_beginning, zip));
