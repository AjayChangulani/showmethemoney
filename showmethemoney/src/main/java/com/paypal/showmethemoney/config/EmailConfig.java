...
public class EmailConfig
{
	...
	private static String email_body_part_mid = "<td width=\"175\" align=\"center\" valign=\"top\"> <table width=\"175\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"> <tr> <td  bgcolor=\"#03bcda\"><p width=\"175\" height=\"14\" style=\"display:block\" border=\"0\"></p></td> </tr> <tr> <td height=\"30\" align=\"center\" valign=\"middle\" bgcolor=\"#03bcda\"><font style=\"font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#ffffff; font-size:20px; text-transform:uppercase\"><strong>%s</strong></font></td> </tr> <tr> <td bgcolor=\"#03bcda\"><p width=\"175\" height=\"18\"></p></td> </tr> <tr> <td align=\"center\" valign=\"middle\" bgcolor=\"#03bcda\"> <font style=\"font-family:'Myriad Pro', Helvetica, Arial, sans-serif; color:#ffffff; font-size:14px\"> <strong>%s</strong> </font> </td> </tr> <tr> <td align=\"center\" valign=\"middle\" bgcolor=\"#03bcda\">&nbsp;</td> </tr> </table> </td><td width=\"19\">&nbsp;</td>";
	static
	{
		mailer = new Mailer(smtp_host, smtp_port, username, password);
	}

	public static void sendEmail(ImmutableList<String> emailIds, ImmutableList<CM2OfferData> offerData)
	{
		...
		email.setTextHTML(getEmailBody(offerData));
		
		mailer.sendMail(email);
	}
	
	private static String getEmailBody(ImmutableList<CM2OfferData> offersData)
	{
		StringBuilder sb = new StringBuilder();
		
		sb.append(email_body_part_beginning);
